...
import { getOfficeManagerById } from 'apiSdk/office-managers';
import { OfficeManagerInterface } from 'interfaces/office-manager';

function OfficeManagerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('office_manager', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/office-managers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Responsibility" text={data?.responsibility} />
