...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'appointment.count', 'it_support.count', 'medical_staff.count', 'office_manager.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('it_support', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'it_support',
          header: 'It Support',
          accessorKey: 'it_support',
          cell: ({ row: { original: record } }: any) => record?._count?.it_support,
        }
      : null,
    hasAccess('medical_staff', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('office_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'office_manager',
          header: 'Office Manager',
          accessorKey: 'office_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.office_manager,
        }
      : null,
