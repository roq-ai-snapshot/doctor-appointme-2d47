...
import { getItSupportById } from 'apiSdk/it-supports';
import { ItSupportInterface } from 'interfaces/it-support';

function ItSupportViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('it_support', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/it-supports/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Expertise" text={data?.expertise} />
